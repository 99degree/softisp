...
**12 GPU dispatches** (minimum after all fusions), 486 tests, 0 warnings.
...
- **486 tests**: 454 lib + 24 integration + 2 e2e
...
```bash
cargo test --lib -p cam-isp --features mnn               # 454 lib tests
