...
**12 GPU dispatches** (minimum after all fusions), 568 tests, 0 warnings.
...
- **568 tests**: 533 lib + 24 integration + 2 e2e
...
```bash
cargo test --lib -p cam-isp --features mnn               # 533 lib tests
