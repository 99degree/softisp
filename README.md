...
**12 GPU dispatches** (minimum after all fusions), 575 tests, 0 warnings.
...
- **575 tests**: 540 lib + 24 integration + 2 e2e
...
```bash
cargo test --lib -p cam-isp --features mnn               # 540 lib tests
