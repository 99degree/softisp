...
**12 GPU dispatches** (minimum after all fusions), 537 tests, 0 warnings.
...
- **537 tests**: 505 lib + 24 integration + 2 e2e
...
```bash
cargo test --lib -p cam-isp --features mnn               # 505 lib tests
