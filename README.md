...
**12 GPU dispatches** (minimum after all fusions), 458 tests, 0 warnings.
...
- **458 tests**: 421 lib + 35 integration + 2 e2e
...
```bash
cargo test --lib -p cam-isp --features mnn               # 421 lib tests
