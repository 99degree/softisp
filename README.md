...
**12 GPU dispatches** (minimum after all fusions), 505 tests, 0 warnings.
...
- **505 tests**: 473 lib + 24 integration + 2 e2e
...
```bash
cargo test --lib -p cam-isp --features mnn               # 473 lib tests
