...
**12 GPU dispatches** (minimum after all fusions), 562 tests, 0 warnings.
...
- **562 tests**: 530 lib + 24 integration + 2 e2e
...
```bash
cargo test --lib -p cam-isp --features mnn               # 530 lib tests
