...
**12 GPU dispatches** (minimum after all fusions), 496 tests, 0 warnings.
...
- **496 tests**: 464 lib + 24 integration + 2 e2e
...
```bash
cargo test --lib -p cam-isp --features mnn               # 464 lib tests
