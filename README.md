...
**12 GPU dispatches** (minimum after all fusions), 549 tests, 0 warnings.
...
- **549 tests**: 517 lib + 24 integration + 2 e2e
...
```bash
cargo test --lib -p cam-isp --features mnn               # 517 lib tests
