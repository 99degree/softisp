...
fn test_mock_model_controller() {
    ...
    println!("  WB: [{:.3}, {:.3}, {:.3}]", params.wb.r, params.wb.g, params.wb.b);
...
fn test_per_frame_variation() {
    ...
    println!("  Frame 1 WB: [{:.3}, {:.3}, {:.3}]", params1.wb.r, params1.wb.g, params1.wb.b);
    println!("  Frame 2 WB: [{:.3}, {:.3}, {:.3}]", params2.wb.r, params2.wb.g, params2.wb.b);
...
fn test_rule_based_vs_neural() {
    ...
    println!("  Rule-based WB: [{:.3}, {:.3}, {:.3}]", 
        params_rule.wb.r, params_rule.wb.g, params_rule.wb.b);
    println!("  Neural WB:     [{:.3}, {:.3}, {:.3}]", 
...
fn test_isp_params_structure() {
    ...
    println!("  WB: [{:.3}, {:.3}, {:.3}]", params.wb.r, params.wb.g, params.wb.b);
    println!("  CCM diagonal: [{:.3}, {:.3}, {:.3}]", 
        params.ccm.matrix[0], params.ccm.matrix[4], params.ccm.matrix[8]);
    println!("  Tone: contrast={:.3}, gamma={:.3}", params.tone.contrast, params.tone.gamma);
}
