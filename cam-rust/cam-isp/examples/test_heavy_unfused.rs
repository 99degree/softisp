...
fn main() {
    ...
    try_blocks("unfused heavy", vec![
        Box::new(cam_isp::blocks::RawInputBlock::new().with_elem_type(6).with_concrete_width(960)),
