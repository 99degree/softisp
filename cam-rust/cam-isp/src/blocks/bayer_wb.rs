...
impl BayerWbBlock {
    pub fn new() -> Self { Self { id: "bayer_wb".into(), prev: None, next: None, frame_tensor: "BayerWbBlock/frame".into(), input_source: String::new(), gains: [1.0; 4] } }
...
impl IspBlock for BayerWbBlock {
    ...
    fn nodes(&self) -> Vec<Vec<u8>> {
        ...
        if self.is_identity_gains() {
            ...
            return vec![Proto::node("Identity", &[&self.input_source], &[&self.frame_tensor], &[])];
        }
        vec![
