...
int main() {
    ...
    std::vector<int8_t> spv1_i8(spv1.size()), spv2_i8(spv2.size()), spv3_i8(spv3.size()), spv4_i8(spv4.size()), spv5_i8(spv5.size());
    ...
    net->bizCode = "5StageISP";
    net->tensorName = {"tensor_0","tensor_1","tensor_2","tensor_3","tensor_4","tensor_5"};
    ...
    auto out = interp->getSessionOutput(sess, "tensor_5");
