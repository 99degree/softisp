// test_3stage.cpp - 3-stage test (unpack -> demosaic -> fcs)
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <stdint.h>
...
int main() {
    ...
    std::vector<int8_t> spv1_i8(spv1.size()), spv2_i8(spv2.size()), spv3_i8(spv3.size());
    ...
    net->bizCode = "3StageISP";
    net->tensorName = {"tensor_0","tensor_1","tensor_2","tensor_3"};
    ...
    // Check final output
    auto out = interp->getSessionOutput(sess, "tensor_3");
